...
const EXPRESSIONS = {
  ...
  PHONE_BY_COUNTRY_CODE: {
    '244': /^\+2449\d{8}$/, '93': /^\+93\d{9}$/, '355': /^\+355\d{8,9}$/, '213': /^\+213\d{9}$/, '376': /^\+376\d{6}$/,
    '1264': /^\+1264\d{7}$/, '1268': /^\+1268\d{7}$/, '54': /^\+54\d{10}$/, '374': /^\+374\d{8}$/, '247': /^\+247\d{5}$/,
    '61': /^\+61\d{9}$/, '43': /^\+43\d{10}$/, '994': /^\+994\d{9}$/, '1242': /^\+1242\d{7}$/, '973': /^\+973\d{7}$/,
    '880': /^\+880\d{10}$/, '1246': /^\+1246\d{7}$/, '375': /^\+375\d{9}$/, '32': /^\+32\d{9}$/, '501': /^\+501\d{7}$/,
    '229': /^\+229\d{7}$/, '1441': /^\+1441\d{7}$/, '591': /^\+591\d{7,8}$/, '267': /^\+267\d{7}$/, '55': /^\+55\d{11}$/,
    '673': /^\+673\d{6}$/, '359': /^\+359\d{9}$/, '226': /^\+226\d{7}$/, '95': /^\+95\d{8,9}$/, '257': /^\+257\d{7}$/,
    '237': /^\+237\d{8}$/, '1': /^\+1\d{10}$/, '1345': /^\+1345\d{7}$/, '236': /^\+236\d{8}$/, '235': /^\+235\d{8}$/,
    '56': /^\+56\d{9}$/, '86': /^\+86\d{11}$/, '57': /^\+57\d{10}$/, '242': /^\+242\d{9}$/, '682': /^\+682\d{4}$/,
    '506': /^\+506\d{8}$/, '53': /^\+53\d{8}$/, '357': /^\+357\d{8}$/, '420': /^\+420\d{9}$/, '45': /^\+45\d{8}$/,
    '253': /^\+253\d{6}$/, '1890': /^\+1890\d{7}$/, '593': /^\+593\d{9}$/, '20': /^\+20\d{9}$/, '503': /^\+503\d{8}$/,
    '372': /^\+372\d{7}$/, '251': /^\+251\d{9}$/, '679': /^\+679\d{7}$/, '358': /^\+358\d{9}$/, '33': /^\+33\d{9}$/,
    '594': /^\+594\d{9}$/, '241': /^\+241\d{6}$/, '220': /^\+220\d{7}$/, '995': /^\+995\d{9}$/, '49': /^\+49\d{11}$/,
    '233': /^\+233\d{9}$/, '350': /^\+350\d{8}$/, '30': /^\+30\d{10}$/, '1809': /^\+1809\d{7}$/, '1671': /^\+1671\d{7}$/,
    '502': /^\+502\d{8}$/, '224': /^\+224\d{8}$/, '592': /^\+592\d{7}$/, '509': /^\+509\d{8}$/, '504': /^\+504\d{8}$/,
    '852': /^\+852\d{8}$/, '36': /^\+36\d{8}$/, '354': /^\+354\d{7}$/, '91': /^\+91\d{10}$/, '62': /^\+62\d{9,12}$/,
    '98': /^\+98\d{9,10}$/, '964': /^\+964\d{10}$/, '353': /^\+353\d{9}$/, '972': /^\+972\d{9}$/, '39': /^\+39\d{10}$/,
    '225': /^\+225\d{8}$/, '1876': /^\+1876\d{7}$/, '81': /^\+81\d{10}$/, '962': /^\+962\d{9}$/, '855': /^\+855\d{8,9}$/,
    '327': /^\+327\d{9}$/, '254': /^\+254\d{9}$/, '82': /^\+82\d{9,10}$/, '965': /^\+965\d{8}$/, '331': /^\+331\d{8}$/,
    '856': /^\+856\d{8,9}$/, '371': /^\+371\d{8}$/, '961': /^\+961\d{7,8}$/, '266': /^\+266\d{8}$/, '231': /^\+231\d{7}$/,
    '218': /^\+218\d{9}$/, '423': /^\+423\d{7}$/, '370': /^\+370\d{8}$/, '352': /^\+352\d{8}$/, '853': /^\+853\d{8}$/,
    '261': /^\+261\d{9}$/, '265': /^\+265\d{7}$/, '60': /^\+60\d{9,10}$/, '960': /^\+960\d{7}$/, '223': /^\+223\d{8}$/,
    '356': /^\+356\d{8}$/, '1670': /^\+1670\d{7}$/, '596': /^\+596\d{9}$/, '230': /^\+230\d{7}$/, '52': /^\+52\d{10}$/,
    '373': /^\+373\d{7}$/, '377': /^\+377\d{8}$/, '976': /^\+976\d{8}$/, '1664': /^\+1664\d{7}$/, '212': /^\+212\d{9}$/,
    '258': /^\+258\d{9}$/, '264': /^\+264\d{9}$/, '674': /^\+674\d{5}$/, '977': /^\+977\d{9}$/, '599': /^\+599\d{7}$/,
    '31': /^\+31\d{9}$/, '64': /^\+64\d{9}$/, '505': /^\+505\d{8}$/, '227': /^\+227\d{8}$/, '234': /^\+234\d{10}$/,
    '850': /^\+850\d{8}$/, '47': /^\+47\d{8}$/, '968': /^\+968\d{8}$/, '92': /^\+92\d{10}$/, '507': /^\+507\d{7}$/,
    '675': /^\+675\d{9}$/, '595': /^\+595\d{8}$/, '51': /^\+51\d{9}$/, '63': /^\+63\d{10}$/, '48': /^\+48\d{9}$/,
    '689': /^\+689\d{6}$/, '351': /^\+351\d{9}$/, '1787': /^\+1787\d{7}$/, '974': /^\+974\d{7}$/, '262': /^\+262\d{9}$/,
    '40': /^\+40\d{9}$/, '7': /^\+7\d{10}$/, '1758': /^\+1758\d{7}$/, '1784': /^\+1784\d{7}$/, '684': /^\+684\d{7}$/,
    '685': /^\+685\d{7}$/, '378': /^\+378\d{6}$/, '239': /^\+239\d{7}$/, '966': /^\+966\d{9}$/, '221': /^\+221\d{9}$/,
    '248': /^\+248\d{7}$/, '232': /^\+232\d{8}$/, '65': /^\+65\d{8}$/, '421': /^\+421\d{9}$/, '386': /^\+386\d{8}$/,
    '677': /^\+677\d{5}$/, '252': /^\+252\d{7}$/, '27': /^\+27\d{9}$/, '34': /^\+34\d{9}$/, '94': /^\+94\d{9}$/,
    '249': /^\+249\d{9}$/, '597': /^\+597\d{7}$/, '268': /^\+268\d{7}$/, '46': /^\+46\d{9}$/, '41': /^\+41\d{9}$/,
    '963': /^\+963\d{9}$/, '886': /^\+886\d{9}$/, '992': /^\+992\d{9}$/, '255': /^\+255\d{9}$/, '66': /^\+66\d{9}$/,
    '228': /^\+228\d{8}$/, '676': /^\+676\d{5}$/, '216': /^\+216\d{8}$/, '90': /^\+90\d{10}$/, '993': /^\+993\d{8}$/,
    '256': /^\+256\d{9}$/, '380': /^\+380\d{9}$/, '971': /^\+971\d{9}$/, '44': /^\+44\d{10,11}$/, '598': /^\+598\d{8}$/,
    '58': /^\+58\d{10}$/, '84': /^\+84\d{9}$/, '967': /^\+967\d{9}$/, '381': /^\+381\d{8,9}$/, '263': /^\+263\d{9}$/,
    '243': /^\+243\d{9}$/, '260': /^\+260\d{9}$/,
  },
} as const;
